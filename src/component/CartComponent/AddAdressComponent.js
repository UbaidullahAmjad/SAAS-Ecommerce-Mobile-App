        ...
        <View style={styles.contentView}>
          ...
          >
            <Input
              ...
              onChangeText={(value) =>
                setState({ ...state, name: value, submited: false })
              }
            />
          ...
          >
            <Select
              ...
              onValueChange={(itemValue) =>
                setState({ ...state, country: itemValue, submited: false })
              }
            >
          ...
          >
            <Input
              ...
              style={GlobalStyles.textInputStyle}
              onChangeText={(value) =>
                setState({ ...state, city: value, submited: false })
              }
            />
          ...
          >
            <Input
              ...
              style={GlobalStyles.textInputStyle}
              onChangeText={(value) =>
                setState({ ...state, postcode: value, submited: false })
              }
            />
            <FormControl.ErrorMessage leftIcon={<InfoOutlineIcon size="xs" />}>
          ...
          <FormControl
            isRequired
            isInvalid={submited && address2 == "" ? true : false}
          >
            <Input
              variant="outline"
              value={address2}
              ...
              style={GlobalStyles.textAreaInputStyle}
              onChangeText={(value) =>
                setState({ ...state, address2: value, submited: false })
              }
            />
            <FormControl.ErrorMessage leftIcon={<InfoOutlineIcon size="xs" />}>
              Address is required
